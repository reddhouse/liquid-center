...
export default () => (
  ...
  >
    <Container>
      ...
      <p>It should be noted that liquid democracy does not <i>require</i> people to be involved in the lawmaking process. Unlike other forms of direct democracy, liquid democracy gives voters the ability to delegate their vote to someone else, perhaps to a friend or colleague with expertise in a certain subject.</p>
      ...
      <p>Since Liquid Center voters are proven to be human, and proven to only have one account (<i>authentication provided by</i> <Link href={"/liquid_technology"}><a>in.dividual</a></Link>), representatives are able to put each of the above features to their own democratic vote. For example, the expiration date for our new law could be 1 year from now, or 5 years from now, and voters get the chance to decide that, separate of the decision to support the law in the first place.</p>
