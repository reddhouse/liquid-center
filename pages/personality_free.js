...
export default () => (
  ...
  >
    <Container>
      ...
      <p>"No personalities" is a bit of stretch. The wonderful group of representatives who have pledged to embrace the Liquid Center platform are obviously intelligent, charismatic folks. Many even have quite charming personalities, but on the job, you might mistake them for robots. They serve to advance no agendas, except those which are <Link href={"/introducing_liquify"}><a>directly communicated by individual voters</a></Link>, and it's perfectly okay to forget their name after election day.</p>
      ...
      <p>If liquid democracy is a new concept to you, please take a moment to read why we think it's <Link href={"/introducing_liquify"}><a>the fastest way to fix everything</a></Link>. You can also learn about Liquid Center's mission to promote and enhance liquid democracy on our <Link href={"/about"}><a>about us</a></Link> page.</p>
